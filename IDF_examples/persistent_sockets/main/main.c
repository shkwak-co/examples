 ...
 */
static esp_err_t
adder_post_handler (httpd_req_t * req)
{
  /* Log total visitors */
...
static esp_err_t
adder_get_handler (httpd_req_t * req)
{
  /* Log total visitors */
  unsigned *visitors = (unsigned *) req->user_ctx;
  ESP_LOGI (TAG, "/adder visitor count = %d", ++(*visitors));
...
static esp_err_t
logout_handler (httpd_req_t * req)
{
...
static esp_err_t
adder_put_handler (httpd_req_t * req)
{
  /* Log total visitors */
  unsigned *visitors = (unsigned *) req->user_ctx;
  ESP_LOGI (TAG, "/adder visitor count = %d", ++(*visitors));
